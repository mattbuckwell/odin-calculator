...
let calculator = {
    ...
    result (equation) {
        ...
        calcDisplay.textContent = "";
        calcDisplay.textContent = this.operate(this.firstNumber, this.operator, this.secondNumber);
    },
}
...
console.log(`Addition of 10 + 10 = ${calculator.operate(10, "+", 10)}`);
console.log(`Subtraction of 1000 - 350 = ${calculator.operate(1000, "-", 350)}`);
console.log(`Multiplication of 50 * 50 = ${calculator.operate(50, "*", 50)}`);
console.log(`Division of 1000 / 10 = ${calculator.operate(1000, "/", 10)}`);